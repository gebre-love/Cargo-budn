...
bot.on("text", async (ctx, next) => {
  ...
  if (step === "HOUSE_PRICE") {
    ...
    const descQ = HOUSE_SEEKING_TYPES.includes(dt)
      ? "📝 የሚፈልጉትን ቤት አጭር መግለጫ ይጻፉ (ክፍሎች ብዛት, ወለል, ምን አይነት ቤት, ወዘተ):"
      : "📝 ስለ ቤቱ አጭር መግለጫ ይጻፉ (ክፍሎች ብዛት, ወለል, ወዘተ):";
    return ctx.reply(descQ, backKb());
  }
...
/* ── House listings (Buy/Sell/Rent) — Admin viewer ──────────── */
