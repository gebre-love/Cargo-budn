...
<table>
  <thead><tr><th>#</th><th>ሙሉ ስም</th><th>ስልክ</th><th>ሰፈር</th><th>ጭነት</th><th class="num">ኪሎ</th><th class="status">ሁኔታ</th><th>ፊርማ</th></tr></thead>
  <tbody>${rows}</tbody>
  <tfoot><tr style="font-weight:bold;background:#dde4ef"><td colspan="5">ጠቅላላ</td><td class="num">${totalKg}</td><td></td><td></td></tr></tfoot>
</table>
